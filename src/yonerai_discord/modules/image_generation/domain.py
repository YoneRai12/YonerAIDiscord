...
IMAGE_GENERATION_MODULE_ID = "media.image-generation"
IMAGE_GENERATION_PLUGIN_NAME = "image_generation"
IMAGE_GENERATION_CAPABILITY_ID = "cap-run-image-generate"
IMAGE_GENERATION_COMMAND_PATH = "image generate"
...
class ImageGenerationAuthorizationError(ImageGenerationError):
    pass


class ImageGenerationContractError(ImageGenerationError):
    pass


class ImageGenerationIdempotencyError(ImageGenerationError):
    pass
...
class ImageGenerationRequest:
    ...
    def provider_request_id(self) -> str:
        return f"image-request-{self.fingerprint[:48]}"
...
def image_artifact_request_binding(
